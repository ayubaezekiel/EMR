...
export const createHMOPlanAction = async (values: DB['hmo_plans']['Insert']) => {
...
export const updateHMOPlanAction = async (values: DB['hmo_plans']['Update']) => {
    if (values.id) {
        const { error } = await supabase.from("hmo_plans").update(values).eq('id', values.id);
        if (error) {
            toast.error(error.message);
        }
...
export const createHMOGroupAction = async (values: DB['hmo_group']['Insert']) => {
...
export const updateHMOGroupAction = async (values: DB['hmo_companies']['Update']) => {
    if (values.id) {
        const { error } = await supabase.from("hmo_group").update(values).eq('id', values.id);
        if (error) {
            toast.error(error.message);
        }
...
export const createHMOCompaniesAction = async (values: DB['hmo_companies']['Insert']) => {
...
export const updateHMOCompaniesAction = async (values: DB['hmo_companies']['Update']) => {
    if (values.id) {
        const { error } = await supabase.from("hmo_companies").update(values).eq('id', values.id);
        if (error) {
            toast.error(error.message);
        }
...
export const deleteHMOCompaniesAction = async ({ id }: { id: string }) => {
    if (id) {
        const { error } = await supabase.from("hmo_companies").delete().eq('id', id);
        if (error) {
            toast.error(error.message);
        }
