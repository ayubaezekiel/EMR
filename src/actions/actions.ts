...
export const getHMOPlans = async () => {
    const { data: hmo_plans_data, error: hmo_plans_error } = await supabase.from("hmo_plans").select("*,hmo_companies(name)");
...
export const getConsultationSpecialties = async () => {
    const { data: consultation_specialties_data, error: specialties_err } = await supabase.from("consultation_specialties").select("*");
...
export const getConsultationTemplates = async () => {
    const { data: consultation_templates_data, error: templates_err } = await supabase.from("consultation_templates").select("*");
...
export const getClinics = async () => {
    const { data: clinics_data, error: clinics_error } = await supabase.from("clinics").select("*");
...
export const getAppointmentTypes = async () => {
    const { data: appointment_type_data, error: appointment_type_error } = await supabase.from("appointments_types").select("*");
