  ...
  <Document>
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.section}>
        <Text style={styles.title}>Pharmacy Request Form</Text>
      </View>
      <View style={styles.section}>
...
export default function PrintPharmacyRequests(props: RequestDataType) {
  ...
  return (
    <IconButton asChild loading={instance.loading}>
      <a href={`${instance.url}`} download="pharmacy_request.pdf">
        <Printer />
      </a>
    </IconButton>
  );
