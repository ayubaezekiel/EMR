...
// export function UpdateConsumableRequestForm(conData: DB["requests"]["Update"]) {
// 	const [isLoading, setIsLoading] = useState(false);
// 	const { isQuantityTypePending, quantity_type_data } = useQuantityType();
...
// 	return (
// 		<Dialog.Root open={open} onOpenChange={onOpenChange}>
// 			<Dialog.Trigger disabled={isDrugPending || isQuantityTypePending}>
// 				<Button
// 					size={"1"}
// 					color="red"
// 					variant="ghost"
// 					loading={isDrugPending || isQuantityTypePending}
// 				>
// 					<Edit />
// 				</Button>
// 			</Dialog.Trigger>
